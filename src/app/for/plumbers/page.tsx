      ...
      <section className="bg-primary py-12 sm:py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-lg sm:text-xl text-gray-200">
            The average plumber misses <strong className="text-white">5+ calls per week</strong>.
            At $350/job, that&apos;s{" "}
            <strong className="text-accent text-2xl sm:text-3xl font-bold">$7,000/month</strong>{" "}
            walking away.
          </p>
        </div>
      </section>
