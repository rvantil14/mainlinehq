          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-primary/5 text-primary">
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 0115 0z" /></svg>
                  </div>
                  <div>
              ...
              <div className="mt-10">
                <a
                  href="https://calendly.com/ryan-mainlinehq"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center gap-3 w-full rounded-lg bg-accent hover:bg-accent-hover text-white py-4 px-6 font-semibold transition-colors shadow-md shadow-accent/25"
                >
              ...
              <div className="mt-8 rounded-lg bg-primary/5 border border-primary/10 p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-dark">Prefer to message instead?</p>
            ...
            {/* Contact Form */}
            <div>
              <div className="rounded-lg bg-white border border-gray-100 shadow-xl p-8 sm:p-10">
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        value={form.message}
                        onChange={handleChange}
                        className="w-full rounded-md border border-gray-200 bg-light-bg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:border-accent focus:ring-2 focus:ring-accent/20 focus:bg-white transition-all resize-none"
